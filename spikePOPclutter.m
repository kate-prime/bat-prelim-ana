...
for idxShape=1:24
   ...
   lookupLARGER={'r','b','m'};
    ...
    [result] = comparison (clutterPOPspikes(maxoutlier,2),clutterPOPspikes(notoutliers(1),2),clutterPOPspikes(notoutliers(2),2),stderror)
    switch (result)
        'larger': s.MarkerFaceColor=lookupLARGER{idx};
        'smaller': s.MarkerFaceColor=lookupSMALLER{idx};
        'murky': s.MarkerFaceColor='w';
    end
